...
export class User {
  ...
  @Prop({ type: SchemaTypes.ObjectId, ref: "Team", index: true }) // Indexed for filtering by team
  teamId?: Types.ObjectId;

  @Prop({ type: SchemaTypes.ObjectId, ref: "Territory", index: true }) // Indexed for filtering by territory
